...
// */
//@Configuration
//@MapperScan(basePackages = "com.workdance.chatbot.dal.mybatisplus.mapper", sqlSessionFactoryRef = "mybatisSqlSession")
//public class MybatisPlusConfig {
//
//  @Bean("mybatisSqlSession")
//  public SqlSessionFactory sqlSessionFactoryForMybatisPlus(@Qualifier(value = "singleDataSource") DataSource dataSource, GlobalConfig globalConfig) throws Exception {
